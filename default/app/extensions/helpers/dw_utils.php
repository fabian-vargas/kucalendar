...
class DwUtils {
    ...
    /*
    *Retorna el dia de la semana en castellano
    */
    public static function diasemana($fechahoy) {
        $dias = array("domingo","lunes","martes","mi&eacute;rcoles","jueves","viernes","s&aacute;bado");
        return ucfirst($dias[$fechahoy]);
        //return $dias[date("w")];
    }


    public static function mesnombre($fechahoy) {
        $meses = array("enero","febrero","marzo","abril","mayo","junio","julio","agosto","setiembre","octubre","noviembre","diciembre");
        return $meses[$fechahoy];
        //return $dias[date("w")];
    }
